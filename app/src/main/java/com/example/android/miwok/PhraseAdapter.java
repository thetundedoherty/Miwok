...
public class PhraseAdapter extends ArrayAdapter<Phrase> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Get the Phrase object located at this position in the list
        ...
        milwokTextView.setText(currentPhrase.getmMiwokTranslation());
        ...
        englishTextView.setText(currentPhrase.getmDefaultTranslation());
